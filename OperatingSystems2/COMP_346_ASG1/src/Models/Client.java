...
public class Client extends Thread{ 
    ...
    {   
    	...
    	if(getClientOperation() == "sending") {
        	...
        	System.out.println("\n Terminating client send thread - " + " Running time " + (sendClientStartTime - sendClientEndTime) + " milliseconds");
        }
        else {
        	...
        	receiveClientEndTime = System.currentTimeMillis();
       	 	...
       	 	System.out.println("\n Terminating client receive thread - " + " Running time " + (receiveClientStartTime - receiveClientEndTime) + " milliseconds");
        }
    }
}
