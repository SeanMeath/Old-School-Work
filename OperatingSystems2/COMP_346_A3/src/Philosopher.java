...
public class Philosopher extends BaseThread
{
	...
	public void eat()
	{
		try
		{
			...
			this.yield();
			System.out.println("Philosopher " + this.getTID() + " has stopped eating");
		}
	...
	public void think()
	{
		try
		{
			...
			sleep((long)(Math.random() * TIME_TO_WASTE));
			this.yield();
			System.out.println("Philosopher " + this.getTID() + " has stopped thinking");
		}
		catch(InterruptedException e)
		{
	...
	public void talk()
	{
		...
		saySomething();
		this.yield();
		System.out.println("Philosopher " + this.getTID() + " has stopped talking");
	}
